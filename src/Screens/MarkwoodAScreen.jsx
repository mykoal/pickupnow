...
const MarkwoodAScreen = () => {
	...
	// when joining a queue position, update CurrentQueue to be 'markwoodA'
	//----
	...
	//NEED IF VIEWING QUEUE AND ALREADY IN IT THE BUTTON SHOULD SHOW AS LEAVE SO NEED A WAY TO SET ISBUTTONCLICKED TO TRUE
			...
			<div className="bg-white overflow-hidden w-[393px] h-[852px] relative">
				...
				{currentPos == 2 && (
					<div className="absolute w-[81px] h-[30px] top-[383px] left-[285px] rounded-[20px]">
						<button
							className="absolute w-[81px] h-[30px] bg-[#0f6e42] border-2 border-solid border-[#053f24] transition-all duration-300 hover:bg-[#06492a] h-[30px] rounded-[20px] top-0 left-0 [font-family:Gabarito] font-normal text-[#f3fbef] text-[20px] text-center tracking-[0] leading-[normal] whitespace-nowrap"
				...
				{/* {currentPos ==-1 && currentQueue.group2.length < 10 &&
          <button className="absolute w-[81px] h-[30px] bg-[#0f6e42] border-2 border-solid border-[#053f24] transition-all duration-300 hover:bg-[#06492a] h-[30px] rounded-[20px] top-0 left-0 [font-family:Gabarito] font-normal text-[#f3fbef] text-[20px] text-center tracking-[0] leading-[normal] whitespace-nowrap" onClick={toggleSlot}>
             {isButtonClicked ? "Leave" : "Join"} {isButtonClicked && localStorage.setItem("currentPos",1)}
          </button>
        } */}

				{/* <div className="absolute w-[81px] h-[30px] top-[496px] left-[284px] rounded-[20px]">
					<div className="absolute w-[81px] h-[30px] bg-[#0f6e42] border-2 border-solid border-[#053f24] transition-all duration-300 hover:bg-[#06492a] h-[30px] rounded-[20px] top-0 left-0 [font-family:Gabarito] font-normal text-[#f3fbef] text-[20px] text-center tracking-[0] leading-[normal] whitespace-nowrap">
						Join
					</div>
				</div> */}
...
export default MarkwoodAScreen;
