	...
	return (
		<div className="bg-white flex flex-row justify-center w-full">
			<div className="bg-white overflow-hidden w-[393px] h-[852px] relative">
				...
				{currentPos == -1 &&
					currentQueue.group5.length < 10 &&
					currentQueue.group5[0].name != "OPEN" && (
				...
				{currentPos == -1 &&
					...
					currentQueue.group4[0].name == "OPEN" && (
						<div className="absolute w-[210px] h-[30px] top-[707px] left-[92px] rounded-[20px]">
							<button
								className="absolute w-[210px] h-[30px] bg-[#0f6e42] border-2 border-solid border-[#053f24] transition-all duration-300 hover:bg-[#06492a] h-[30px] rounded-[20px] top-0 left-0 [font-family:Gabarito] font-normal text-[#f3fbef] text-[20px] text-center tracking-[0] leading-[normal] whitespace-nowrap"
								onClick={group4_button}>
								{!isButtonClicked
									? "Join End of Queue"
									: "Leave"}
