...
const SamsonAScreen = () => {
	//-------------------------UPDATED------------------------------
	//--------------------------------------------------------------
	let currentQueue = JSON.parse(localStorage.getItem("samsonA"));
	...
	const group2_button = () => {
		if (!isButtonClicked) {
			...
			localStorage.setItem("samsonA", JSON.stringify(currentQueue));
			currentPos = 2;
			localStorage.setItem("currentPos", currentPos);
			localStorage.setItem("currentQueue", "samsonA");
