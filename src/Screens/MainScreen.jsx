			...
			<div className="bg-white overflow-hidden w-[393px] h-[852px] relative">
				...
				{currentPos != -1 && (
					<div className="absolute w-[293px] h-[206px] top-[300px] left-[50px]">
						...
						<div className="absolute w-[293px] h-[198px] top-[28px] left-0 bg-[#f3fbef] rounded-[14px] border-2 border-solid border-[#0f6e42]" />
						...
						<p className="absolute w-[203px] top-[187px] left-[45px] [font-family:Gabarito] font-normal text-black text-[12px] text-center tracking-[0] leading-[normal]">
